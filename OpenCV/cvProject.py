...
''' Takes parameter original image,
Lower bound and Upper bound of selected color and
image of aurco maker'''
...
'''Black color -> id = 3
Ha.jpg has aruco marker has id = 3'''
imgAug = cv.imread('Photos/Ha.jpg')
lower_bound = np.array([0, 0, 0])
upper_bound = np.array([2, 2, 2])
img = placeAruco(img, lower_bound, upper_bound, imgAug)

'''Pink Peach color -> id = 4
HaHa.jpg has aruco marker has id = 4'''
